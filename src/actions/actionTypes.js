...
export const GET_USER_INTEREST_SUCCESS = 'GET_USER_INTEREST_SUCCESS';
export const GET_USER_INTEREST_ERROR = 'GET_USER_INTEREST_ERROR';

export const ADD_USER_INTEREST = 'ADD_USER_INTEREST';
export const ADD_USER_INTEREST_SUCCESS = 'ADD_USER_INTEREST_SUCCESS';
export const ADD_USER_INTEREST_ERROR = 'ADD_USER_INTEREST_ERROR';
...
export const REVIEW_QR = 'REVIEW_QR';
export const REVIEW_QR_SUCCESS = 'REVIEW_QR_SUCCESS';
export const REVIEW_QR_ERROR = 'REVIEW_QR_ERROR';
